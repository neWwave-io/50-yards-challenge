-- 0021_leaderboard_named_only.sql
-- A profile with neither a display name nor a child name is a sign-up that
-- was never finished. It is not a participant yet, so it stays off the board
-- until it has a name.
--
