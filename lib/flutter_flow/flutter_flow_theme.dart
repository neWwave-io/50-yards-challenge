...
abstract class FlutterFlowTheme {
  ...
  late Color greenWhite;
  late Color richBlackFOGRA39;
  late Color generalGreen;
  late Color letterGreen;
  late Color darkGreen;
  late Color paleGreen;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF3A4A1D);
  ...
  late Color accent1 = const Color(0xFF5F6B4B);
  ...
  late Color greenWhite = const Color(0xFFF8FEEE);
  late Color richBlackFOGRA39 = const Color(0xFF070707);
  late Color generalGreen = const Color(0xFF4FAB24);
  late Color letterGreen = const Color(0xFF388F0F);
  late Color darkGreen = const Color(0xFF3A4A1D);
  late Color paleGreen = const Color(0xFF7C8869);
}
