import 'dart:io';
import '/main.dart';
import '/backend/schema/util/firestore_util.dart' show toRef;
...
export '/backend/supabase_compat/compat_types.dart'
    show DocumentReference, CollectionReference, Query, FieldValue;
...
extension StringDocRef on String {
  DocumentReference get ref => toRef(this);
}
