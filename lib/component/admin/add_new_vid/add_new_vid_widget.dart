...
import 'add_new_vid_model.dart';
export 'add_new_vid_model.dart';

class AddNewVidWidget extends StatefulWidget {
  const AddNewVidWidget({super.key});

  @override
  State<AddNewVidWidget> createState() => _AddNewVidWidgetState();
}

class _AddNewVidWidgetState extends State<AddNewVidWidget> {
  late AddNewVidModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewVidModel());
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'Input Your Annoucement',
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        font: GoogleFonts.poppins(
                            ...
                            onPressed: () async {
                              await AnnouncementRecord.collection
                                  ...
                                  .set(createAnnouncementRecordData(
                                    ...
                                    type: AnnouncementType.video.name,
                                    videoLink: _model.emailTextController2.text,
