...
import 'add_new_article_model.dart';
export 'add_new_article_model.dart';
...
class AddNewArticleWidget extends StatefulWidget {
  const AddNewArticleWidget({super.key});

  @override
  State<AddNewArticleWidget> createState() => _AddNewArticleWidgetState();
}

class _AddNewArticleWidgetState extends State<AddNewArticleWidget> {
  late AddNewArticleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewArticleModel());
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataAl9 = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadDataAl9 =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataAl9 =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataAl9 =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                                ...
                                _model.hashcode = _model
                                    .uploadedLocalFile_uploadDataAl9.blurHash;
                              ...
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    if (_model.isuploading == false) {
                                      return Builder(
                                        builder: (context) {
                                          if (_model.iamge != null &&
                                              _model.iamge != '') {
                                            return ClipRRect(
                                              borderRadius:
                            ...
                            onPressed: () async {
                              await AnnouncementRecord.collection
                                  ...
                                  .set(createAnnouncementRecordData(
                                    title: _model.childnameTextController.text,
                                    description:
                                        _model.emailTextController1.text,
                                    type: AnnouncementType.article.name,
                                    articleLink:
                                        _model.emailTextController2.text,
                                    imageDetail: updatePhotoDetailStruct(
                                      PhotoDetailStruct(
                                        image: _model
                                            .uploadedFileUrl_uploadDataAl9,
                                        hashCodeImage: _model
                                            .uploadedLocalFile_uploadDataAl9
                                            .blurHash,
                                      ),
