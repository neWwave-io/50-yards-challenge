...
import '/component/empty_notification/empty_notification_widget.dart';
...
class NotificationPopUpWidget extends StatefulWidget {
  ...
  final List<NotificationsRecord>? notifications;
            ...
            builder: (context) {
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children:
                      List.generate(notifications.length, (notificationsIndex) {
