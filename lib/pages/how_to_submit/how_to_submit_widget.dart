...
import 'how_to_submit_model.dart';
export 'how_to_submit_model.dart';

class HowToSubmitWidget extends StatefulWidget {
  const HowToSubmitWidget({super.key});

  static String routeName = 'HowToSubmit';
  static String routePath = '/howToSubmit';

  @override
  State<HowToSubmitWidget> createState() => _HowToSubmitWidgetState();
}

class _HowToSubmitWidgetState extends State<HowToSubmitWidget>
    with TickerProviderStateMixin {
  late HowToSubmitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HowToSubmitModel());
                ...
                Stack(
                  children: [
                    ...
                    Opacity(
                      opacity: 0.7,
                      child: Align(
                        alignment: AlignmentDirectional(-1.24, -0.73),
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 2400.0, 0.0, 0.0),
                          child: ClipRRect(
                                  ...
                                  children: [
                                    Flexible(
                                      child: Container(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.btnForNewVerModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
