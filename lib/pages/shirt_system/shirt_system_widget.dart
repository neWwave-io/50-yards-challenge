...
import 'shirt_system_model.dart';
export 'shirt_system_model.dart';

class ShirtSystemWidget extends StatefulWidget {
  const ShirtSystemWidget({super.key});

  static String routeName = 'ShirtSystem';
  static String routePath = '/shirtSystem';

  @override
  State<ShirtSystemWidget> createState() => _ShirtSystemWidgetState();
}

class _ShirtSystemWidgetState extends State<ShirtSystemWidget> {
  late ShirtSystemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShirtSystemModel());
  }
                                  ...
                                  child: Padding(
                                    ...
                                    child: Stack(
                                      children: [
                                        Align(
                                          alignment:
                                              AlignmentDirectional(1.23, 0.01),
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.asset(
                                              'assets/images/image_89.png',
                                              width: 114.5,
                                              fit: BoxFit.contain,
                                            ),
                                          ),
