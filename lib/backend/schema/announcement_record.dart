...
class AnnouncementRecord extends FirestoreRecord {
  ...
  static CollectionReference get collection =>
      CollectionReference('v1_announcement');

  static Stream<AnnouncementRecord> getDocument(DocumentReference ref) =>
      documentStream(ref, AnnouncementRecord.fromSnapshot);

  static Future<AnnouncementRecord> getDocumentOnce(DocumentReference ref) =>
      documentOnce(ref, AnnouncementRecord.fromSnapshot).then((r) => r!);

  static Future<AnnouncementRecord?> getDocumentOnceOrNull(DocumentReference ref) =>
      documentOnce(ref, AnnouncementRecord.fromSnapshot);
