...
class ShirtRequestsRecord extends FirestoreRecord {
  ...
  static CollectionReference get collection =>
      CollectionReference('v1_shirt_requests');

  static Stream<ShirtRequestsRecord> getDocument(DocumentReference ref) =>
      documentStream(ref, ShirtRequestsRecord.fromSnapshot);

  static Future<ShirtRequestsRecord> getDocumentOnce(DocumentReference ref) =>
      documentOnce(ref, ShirtRequestsRecord.fromSnapshot).then((r) => r!);

  static Future<ShirtRequestsRecord?> getDocumentOnceOrNull(DocumentReference ref) =>
      documentOnce(ref, ShirtRequestsRecord.fromSnapshot);
