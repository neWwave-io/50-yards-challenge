...
class LeaderboardsRecord extends FirestoreRecord {
  ...
  void _initializeFields() {
    ...
    _starOfMonth = toRefOrNull('v1_users', snapshotData['star_of_month']);
  }

  static CollectionReference get collection =>
      CollectionReference('v1_leaderboards');

  static Stream<LeaderboardsRecord> getDocument(DocumentReference ref) =>
      documentStream(ref, LeaderboardsRecord.fromSnapshot);

  static Future<LeaderboardsRecord> getDocumentOnce(DocumentReference ref) =>
      documentOnce(ref, LeaderboardsRecord.fromSnapshot).then((r) => r!);

  static Future<LeaderboardsRecord?> getDocumentOnceOrNull(DocumentReference ref) =>
      documentOnce(ref, LeaderboardsRecord.fromSnapshot);
