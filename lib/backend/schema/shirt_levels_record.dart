...
class ShirtLevelsRecord extends FirestoreRecord {
  ...
  static CollectionReference get collection =>
      CollectionReference('v1_shirt_levels');

  static Stream<ShirtLevelsRecord> getDocument(DocumentReference ref) =>
      documentStream(ref, ShirtLevelsRecord.fromSnapshot);

  static Future<ShirtLevelsRecord> getDocumentOnce(DocumentReference ref) =>
      documentOnce(ref, ShirtLevelsRecord.fromSnapshot).then((r) => r!);

  static Future<ShirtLevelsRecord?> getDocumentOnceOrNull(DocumentReference ref) =>
      documentOnce(ref, ShirtLevelsRecord.fromSnapshot);
