...
class NotificationsRecord extends FirestoreRecord {
  ...
  void _initializeFields() {
    _notification = toRefOrNull('v1_users', snapshotData['notification']);
    _title = snapshotData['title'] as String?;
    _body = snapshotData['body'] as String?;
    _type = snapshotData['type'] as String?;
    _shirtRequestRef = toRefOrNull('v1_shirt_requests', snapshotData['shirt_request_ref']);
  ...
  static CollectionReference get collection =>
      CollectionReference('v1_notifications');

  static Stream<NotificationsRecord> getDocument(DocumentReference ref) =>
      documentStream(ref, NotificationsRecord.fromSnapshot);

  static Future<NotificationsRecord> getDocumentOnce(DocumentReference ref) =>
      documentOnce(ref, NotificationsRecord.fromSnapshot).then((r) => r!);

  static Future<NotificationsRecord?> getDocumentOnceOrNull(DocumentReference ref) =>
      documentOnce(ref, NotificationsRecord.fromSnapshot);
